	...
	public TelaAtualizarCliente() {
		...
		btnSalvarCliente.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Controller.updateCliente(idCliente, nomeCliente, enderecoCliente, telCliente, cepCliente, emailCliente);
				
				setVisible(false); 
				dispose(); 
			}
		});	
		btnSalvarCliente.setBounds(363, 220, 96, 21);
		contentPane.add(btnSalvarCliente);
		
		txtIdCliente = new JTextField();
		txtIdCliente.setBounds(266, 9000, 96, 19);
